                  ...
                  Row(
                    ...
                    children: [
                      ...
                      const Flexible(
                        ...
                        child: Text(
                          '''
You have to cross all the objects from the south to the north using this bridge. You can only cross one object at a time.
''',
                        ),
                      ),
                    ],
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      const Flexible(
                        ...
                        child: Text(
                          '''
Press SPACE or DROP button if you want to release the object.
''',
                        ),
                      ),
                    ],
